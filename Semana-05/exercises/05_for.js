...
var array5A = ['guitar', 'piano' , 'drums' , 'ukulele' , 'saxophone'];

for(var i = 0; i < array5A.length; i++){
    alert(array5A[i]);
}

// b. Al array anterior convertir la primera letra de cada palabra en 
// mayúscula y mostrar una alerta por cada palabra modificada.

console.log('-Exercise 5.b:');

for(var i = 0; i < array5A.length; i++){
    alert(array5A[i].substring(0,1).toUpperCase() + array5A[i].substring(1).toLowerCase());
}
