...
console.log('The fifth and the eleventh months are: ' , array3A[4], array3A[10]);
...
array3A.sort();
console.log('Alphabetically ordered months: ' , array3A);
...
array3A.push('End');
console.log('The array with the added elements is: ', array3A);
...
array3A.shift();
array3A.pop();
console.log('The array with the removed elements is: ', array3A);
...
array3A.reverse();
console.log('The reversed array is: ', array3A);
...
console.log('The new string is: ', array3A.join('-'));
